...
class MainActivity : ComponentActivity() {
    private lateinit var viewModel: CueViewModel
    private val screenshotScene by lazy {
        CueScreenshotScene.fromIntentValue(intent?.getStringExtra(CueScreenshotScene.extraKey()))
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(
            this,
            CueViewModelFactory(graph)
        )[CueViewModel::class.java]
